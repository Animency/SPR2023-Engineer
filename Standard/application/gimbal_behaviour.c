...
//            !SWITCH_LEFT_IS_DOWN(gimbal_mode_set->gimbal_rc_ctrl->rc.s[GIMBAL_MODE_CHANNEL]))
//        {
//            return;
//        }
//        else
...
//    //开关控制 云台状态
//    if (SWITCH_LEFT_IS_DOWN(gimbal_mode_set->gimbal_rc_ctrl->rc.s[GIMBAL_MODE_CHANNEL]))
//    {
//        gimbal_behaviour = GIMBAL_ZERO_FORCE;
//    }
//    else if (SWITCH_LEFT_IS_MID(gimbal_mode_set->gimbal_rc_ctrl->rc.s[GIMBAL_MODE_CHANNEL]))
//    {
//        gimbal_behaviour = GIMBAL_RELATIVE_ANGLE;
//    }
//    else if (SWITCH_LEFT_IS_UP(gimbal_mode_set->gimbal_rc_ctrl->rc.s[GIMBAL_MODE_CHANNEL]))
//    {
...
static void gimbal_absolute_angle_control(float *yaw, float *pitch, gimbal_control_t *gimbal_control_set)
{
    ...
    *pitch = pitch_channel * PITCH_RC_SEN + gimbal_control_set->gimbal_rc_ctrl->mouse.y * PITCH_MOUSE_SEN;
...

    {
        ...
        static float gimbal_end_angle = 0.0f;
