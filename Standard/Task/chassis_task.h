...
typedef struct
{
  ...
  pid_type_def motor_speed_pid[4];             //motor speed PID.底盘电机速度pid
	pid_type_def motor_speed_auto_pid[4];        //motor speed PID.底盘自动化电机速度pid
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
  pid_type_def chassis_auto_right_pid;              //底盘自动化pid
  pid_type_def chassis_auto_left_pid;              //底盘自动化pid
