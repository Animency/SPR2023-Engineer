...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    remote_control_init();
    usart1_tx_dma_init();
	slave_uart_trigger_init();
	nvidia_board_uart_init();
  ...
  HAL_TIM_PWM_Start(&htim4, TIM_CHANNEL_4);
	...
	//PID_init(&speed_pid,SPEED_P,SPEED_I,SPEED_D,3500,200);
  /* USER CODE END 2 */
...
//	du += 0.7;
//	
//	  //speed_sj  = 4096 + sin(du * (3.1415926535)/180.0) * 8191 ;
//		speed_sj  = 100 + sin(du * (3.1415926535)/180.0) * 100;
