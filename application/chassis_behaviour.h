/**
  ...
  *
  ...
  ==============================================================================
    ...
    2. implement new function. chassis_xxx_xxx_control(float *vx, float *vy, float *wz, chassis_move_t * chassis )
...
#define CHASSIS_REMOTE_CONTROL_CHANGE_TO_VEL 0.005741f //0.006377f
