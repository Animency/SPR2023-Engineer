/**
  ...
  *
  ...
  ==============================================================================
    ...
    2. implement new function. gimbal_xxx_xxx_control(float *yaw, float *pitch, gimbal_control_t *gimbal_control_set);
    ...
    2. 实现一个新的函数 gimbal_xxx_xxx_control(fp32floatw, fp32floattch, gimbal_control_t *gimbal_control_set);
